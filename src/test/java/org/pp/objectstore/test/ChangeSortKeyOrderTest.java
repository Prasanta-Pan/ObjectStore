...
public class ChangeSortKeyOrderTest extends AbstractTest {
	/**
	...
	public void test() throws Exception {
		...
		openAndClose("CustomerWithSortKey");
		// redefine customer class and reload class
		try {
			openAndClose("CustomerSortKeyOrderChange");
		} catch (RuntimeException e) {
			if (!e.getMessage().equals("SortKey list doesn't match"))
				throw e;
		}
	}
	
	// CustomerWithSortKey
	// CustomerSortKeyOrderChange
